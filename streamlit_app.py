...
The models, which included ΔPP, achieved ROC AUC scores significantly higher than the baseline (0.5), reaching up to 0.744.This indicates that ΔPP does contribute to some predictive signal, but overall performance is still moderate.
